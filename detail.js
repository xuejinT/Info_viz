...
var margin_s = {top: 0, right: 0, bottom: 0, left:0 },
  width_s = 560 - margin_s.left - margin_s.right,
...
d3.dsv('\\', './data/US_final.csv').then(function(dataset) {
  ...
  bandScale = d3.scaleBand().domain(bandscale_domain).range([40,524]);
...
function updatelinechart(){
  ...
  timeaxis = d3.axisBottom(x_s)
        .tickFormat(d3.timeFormat("%d %b"))
        .ticks(d3.timeDay)
  y_l.domain([0,d3.max(selectedattitudedata,function(d){return d.views})])
  y_r.domain([0,d3.max(selectedattitudedata,function(d){return d.likes})])
